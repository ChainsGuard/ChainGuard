...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@blockchain": path.resolve(__dirname, "./src/features/blockchain"),
      "@documents": path.resolve(__dirname, "./src/features/documents"),
      "@guardian": path.resolve(__dirname, "./src/features/guardian"),
      "@nft": path.resolve(__dirname, "./src/features/nft"),
      "@vault": path.resolve(__dirname, "./src/features/vault"),
    },
  },
  server: {
    port: 3000,
